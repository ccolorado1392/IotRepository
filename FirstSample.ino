...
void loop()
{
  ...
  json.toCharArray(payload2,json.length()+1);
   //JSON para luminiosidad
  json = "{\"value\": "+ String(adcValue) + "}";
  ...
  if ( !isnan(h) && !isnan(t) && !isnan(adcValue) ) {
