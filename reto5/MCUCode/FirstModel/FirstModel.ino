...
#define LED D1 // Led in NodeMCU at pin GPIO5 (D0). 
...
const char ssid[] = "COLTAP"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "1013634019"; // TODO cambiar por la contraseña de la red WiFi
...
const char MQTT_HOST[] = "3.234.205.158"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
...
void receivedCallback(char* topic, byte* payload, unsigned int length) {
  Serial.print("Alerta o Warning Detected");
